...
_menuA = [
			["   Are you sure?", RTMS_DEFAULT_SUB_COLOR, RTMS_DEFAULT_SUB_SIZE, RTMS_DEFAULT_SUB_TEXT_SIZE, "PuristaMedium", {player setdamage 1;}, [], _distance, [], RTMS_DEFAULT_SUB_ICON]
		];
...
_menuB = [
			["   Scroll Override", RTMS_DEFAULT_SUB_COLOR, RTMS_DEFAULT_SUB_SIZE, RTMS_DEFAULT_SUB_TEXT_SIZE, "PuristaMedium", RTMS_PushSubMenu, [_menuBA], _distance, [], RTMS_DEFAULT_SUB_ICON]
		];

_menuItems = 
	[
		["  Inventory", RTMS_DEFAULT_SUB_COLOR, RTMS_DEFAULT_SUB_SIZE, RTMS_DEFAULT_SUB_TEXT_SIZE, "PuristaMedium", {player action ["Gear", (_this select 0)];}, [], _distance, [], "A3\ui_f\data\IGUI\Cfg\Actions\gear_ca.paa"],
		["  Suicide", RTMS_DEFAULT_SUB_COLOR, RTMS_DEFAULT_SUB_SIZE, RTMS_DEFAULT_SUB_TEXT_SIZE, "PuristaMedium", RTMS_PushSubMenu, [_menuA], _distance, [], RTMS_DEFAULT_SUB_ICON],
		["  RTMS Options", RTMS_DEFAULT_SUB_COLOR, RTMS_DEFAULT_SUB_SIZE, RTMS_DEFAULT_SUB_TEXT_SIZE, "PuristaMedium", RTMS_PushSubMenu, [_menuB], _distance, [], RTMS_DEFAULT_SUB_ICON]
	];
