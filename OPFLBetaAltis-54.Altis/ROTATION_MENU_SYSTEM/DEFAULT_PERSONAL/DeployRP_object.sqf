...
_menuItems = 
	[
		["  DEPLOY RP", RTMS_DEFAULT_SUB_COLOR, RTMS_DEFAULT_SUB_SIZE, RTMS_DEFAULT_SUB_TEXT_SIZE, "PuristaMedium", {if (!isNil "OPFL_Client_AttemptDeployRP") then {call OPFL_Client_AttemptDeployRP;};}, [], _distance, [], RTMS_DEFAULT_SUB_ICON]
	];
