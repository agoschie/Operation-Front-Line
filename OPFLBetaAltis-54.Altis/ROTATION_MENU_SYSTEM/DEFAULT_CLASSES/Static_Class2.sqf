...
_menuItems = 
[
	["Disassemble", RTMS_DEFAULT_SUB_COLOR, RTMS_DEFAULT_SUB_SIZE, RTMS_DEFAULT_SUB_TEXT_SIZE, "PuristaMedium", {player action ["Disassemble", (_this select 0)];}, [], _distance, [[], {(alive (_this select 0)) && (1 > count crew (_this select 0))}], RTMS_DEFAULT_SUB_ICON]
];
