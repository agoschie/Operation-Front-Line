...
_class = "House"; //put a "class" or a "kind" in these quotes (example, "Air", "Car", "Tank", "Plane", "Helicopter", "Man", "Offroad_01")

_text = "House"; //text you want to display on the icon if this menu has priority
...
_distance = "ADAPT";  //distance before you can see and select the icon AND sub menus! 
