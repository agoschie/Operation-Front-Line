...
_icon = "a3\ui_f\data\gui\cfg\Hints\rifle_ca.paa"; //This is the icon texture path. Replace this with a similar path to another icon, or make a custom one

_mainColor = RTMS_DEFAULT_COLOR; //color of the icon if this menu has priority, currently set at default

_mainScript = [[], PKS_ActivateArmoryGUI]; //takes form [[ARGS], CODE], otherwise empty array []
